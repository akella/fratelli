...
// 		var tab_cur = $(this).attr('id');
// 		var tab_pos = $('.tabs__inner').position().left;	
// 		var tab_cur_pos = $('#'+tab_cur).position().left;
// 		alert(tab_pos+'='+tab_cur_pos);
// 		if (tab_cur_pos == tab_pos) {
// 			$('div').attr('data-item', tab_cur).addClass('active');
// 		};
// 	});
// }
